...
public class AudioDownload implements Serializable {
	...
	private String mLocalPath = Environment.getExternalStorageDirectory()
			.getAbsolutePath()
			+ "/Android/data/net.ememed.doctor2/ememed#ememeduserofficial/97908"; // 本地存放目录
	...
	public static AudioDownload download = null;

	public static AudioDownload getInstance() {

		if (download == null) {
			download = new AudioDownload();
			// download = new Download(downloadId, url, localPath);
		}
		return download;
	}
	 ...
	 *            本地存放地址
	 */
	public AudioDownload(int downloadId, String url, String localPath) {
	 ...
	 * @return this
	 */
	public AudioDownload setOnDownloadListener(OnDownloadListener listener) {
		mListener = listener;
		return this;
	}

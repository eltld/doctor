...
public class ColoredRatingBar extends View {
    ...
    private void init(Context context) {
        ...
        if(mType==SMALL){
//            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_red_small),BitmapFactory.decodeResource(res, R.drawable.star_orange_small),BitmapFactory.decodeResource(res, R.drawable.star_green_small),BitmapFactory.decodeResource(res, R.drawable.star2)};
        	progressForground =  BitmapFactory.decodeResource(res, R.drawable.star2);
        	progressBackground = BitmapFactory.decodeResource(res, R.drawable.star1);
        }else{
        	progressForground =  BitmapFactory.decodeResource(res, R.drawable.star2);
        	progressBackground = BitmapFactory.decodeResource(res, R.drawable.star1);
//            drawables = new Bitmap[]{BitmapFactory.decodeResource(res, R.drawable.star_red),BitmapFactory.decodeResource(res, R.drawable.star_orange),BitmapFactory.decodeResource(res, R.drawable.star_green),BitmapFactory.decodeResource(res, R.drawable.star2)};

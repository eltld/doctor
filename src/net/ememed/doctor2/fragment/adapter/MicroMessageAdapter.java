...
import net.ememed.doctor2.activity.MicroChatActivity;
...
public class MicroMessageAdapter extends BaseAdapter {
	...
	private MicroChatActivity context;
	private Fragment fragment;
	private Gson gson;
	List<EMMessage> data;
	String orderid;

	public MicroMessageAdapter(Fragment fragment, MicroChatActivity context,
				...
				public void onClick(View v) {
					...
					if (message.getType() == EMMessage.Type.TXT)
						fragment.startActivityForResult(intent,
								MicroChatFragment.REQUEST_CODE_TEXT);
					else if (message.getType() == EMMessage.Type.VOICE)
						fragment.startActivityForResult(intent,
								MicroChatFragment.REQUEST_CODE_VOICE);
					else if (message.getType() == EMMessage.Type.IMAGE)
						fragment.startActivityForResult(intent,
								MicroChatFragment.REQUEST_CODE_PICTURE);
					else if (message.getType() == EMMessage.Type.LOCATION)
						fragment.startActivityForResult(intent,
								MicroChatFragment.REQUEST_CODE_LOCATION);
					else if (message.getType() == EMMessage.Type.FILE)
						fragment.startActivityForResult(intent,
								MicroChatFragment.REQUEST_CODE_RESEND_NET_DISK);
					else if (message.getType() == EMMessage.Type.VIDEO)
						fragment.startActivityForResult(intent,
								MicroChatFragment.REQUEST_CODE_VIDEO);
		...
		holder.iv.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				fragment.startActivityForResult((new Intent(context,
						...
						MicroChatFragment.REQUEST_CODE_CONTEXT_MENU);
				return true;
			}
		});
		if (message.direct == EMMessage.Direct.RECEIVE) {
			...
			if (message.status == EMMessage.Status.INPROGRESS) {
				...
				if (imgBody.getLocalUrl() != null) {
					...
					System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!   "+imgBody.getLocalUrl());

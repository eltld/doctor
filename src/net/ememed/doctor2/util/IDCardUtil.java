...
public class IDCardUtil {
    ...
    public static String IDCardValidate(String IDStr) {
        ...
        if (IDStr.length() == 18) {
        	StringBuilder aimIDStr = new StringBuilder(IDStr);
            if(IDStr.charAt(17) == 'x') {
            	aimIDStr.setCharAt(17, 'X');
            }
            if (Ai.equals(aimIDStr.toString()) == false) {
    ...
    public static boolean isDate(String strDate) {
    	Pattern pattern = Pattern
                .compile("^((\\d{2}(([02468][048])|([13579][26]))[\\-\\/\\s]?((((0?[13578])|(1[02])" +
                		...
                		"(\\d{2}(([02468][1235679])|([13579][01345789]))[\\-\\/\\s]?((((0?[13578])|(1[" +
                		"02]))[\\-\\/\\s]?((0?[1-9])|([1-2][0-9])|(3[01])))|(((0?[469])|(11))[\\-\\/\\" +

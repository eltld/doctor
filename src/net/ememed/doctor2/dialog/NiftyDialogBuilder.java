...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private final String defDividerColor="#8A2BE2";
...
//    private View mDivider;
    ...
    public NiftyDialogBuilder(Activity activity) {
        super(activity);
        init(activity);

    }
    public NiftyDialogBuilder(Activity activity,int theme) {
    ...
    public static NiftyDialogBuilder getInstance(Activity activity) {
        if (instance == null) {
//            synchronized (NiftyDialogBuilder.class) {
//                if (instance == null) {
                    instance = new NiftyDialogBuilder(activity, R.style.dialog_untran);
//                }
            }
//        }
        return instance;
    ...
    private void init(Activity activity) {
    	...
    	if(mDialogView == null){
    		mDialogView = View.inflate(activity, R.layout.dialog_layout, null);
    	}
...
//    }
    ...
    public NiftyDialogBuilder setCustomView(int resId, Activity activity) {
        View customView = View.inflate(activity, resId, null);
    ...
    public NiftyDialogBuilder setCustomView(View view, final Activity activity) {
        if (mFrameLayoutCustomView.getChildCount()>0){
            mFrameLayoutCustomView.removeAllViews();
        }

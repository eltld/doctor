...
//		imageUrls = getIntent().getExtras().getStringArray("imageUrls");
		imageUrls = (List<String>) getIntent().getExtras().getSerializable("imageUrls");
		ViewPager pager = (ViewPager) findViewById(R.id.pager);
		pager.setAdapter(new ImageAdapter());
		pager.setCurrentItem(getIntent().getExtras().getInt("position", 0));
	}
	...
	private class ImageAdapter extends PagerAdapter {
		...
		ImageAdapter() {
			inflater = LayoutInflater.from(ShowImageActivity.this);
		}

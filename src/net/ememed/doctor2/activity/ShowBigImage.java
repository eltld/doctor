...
import net.ememed.doctor2.task.LoadLocalBigImgTask;
import net.ememed.doctor2.util.BitmapUtil;
import net.ememed.doctor2.util.ImageCache;
import net.ememed.doctor2.widget.photoview.PhotoView;
...
public class ShowBigImage extends Activity {
	...
	private int default_res = R.drawable.avatar_large;
	...
	private void downloadImage(final String remoteFilePath,
		...
		if (!showAvator) {
			...
			if (remoteFilePath.contains("/")) {// XXX 错误空指针异常

...
import net.ememed.doctor2.fragment.PreeChatFragment;
...
public class PreeChatActivity extends BasicActivity{
	private PreeChatFragment mChatFragment;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mChatFragment = (PreeChatFragment) Fragment.instantiate(this,
				PreeChatFragment.class.getName());
		connectionIM();
